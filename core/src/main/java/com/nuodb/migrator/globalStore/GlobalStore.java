...
//    private Table table;
    ...
    /**
     * Generates an ALTER statement based on the loaded table data.
     * This method creates an ALTER statement to modify columns in the table that have associated sequences
     * and a generator set to 'GENERATED ALWAYS AS DEFAULT'.
     *
     * @param table The LoadTable object representing the table with loaded data.
     * @return The generated ALTER statement as a String if the column has 'GENERATED ALWAYS AS DEFAULT' generator,
     * or null if no alterations are needed or the generator is 'GENERATED BY DEFAULT AS IDENTITY'.
     */
...
//        try {
            ...
            for (Column col : table.getTable().getColumns()) {
                if (col.getSequence() != null) {
                    ...
                    if(generatedValues == null) return null;
//                    else{
...
//               logger.debug("Issues while creating ALTER STATEMENT:" , e);
//           }
//        }
