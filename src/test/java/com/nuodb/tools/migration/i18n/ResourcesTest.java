...
public class ResourcesTest {
    ...
    public static final String RESOURCE_NAME = "migration.cli.migration.group.name";
    public static final String BUNDLE_NAME = "com.nuodb.tools.migration.i18n.messages";
