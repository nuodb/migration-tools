...
insert into testdata_char (c1,c2,c3)  values('user /s user','log''s log','aåbäcö');
insert into testdata_char (c1,c2,c3)  values('Bientôt l été',' ','ÖÛ«Âé®üçÚŸ±²Ìñ¿øÞ°¯õÁæ­ûÊîâïÃÕôûçµé÷°ÆêüªŽåŸúô«áÄô');
*/
...
insert into testdata_character (c1,c2,c3)  values('æ¥æ¬èª',' ','/?µ?ö??f?ÝøÀÚ?t?ª®?Î???Ë???ðnø§?íèÏ??Õ"?Ë?»?âõ??');*/
...
insert into testdata_charactervarying (c1,c2,c3)  values('Bientôt l été',' ','ÖÛ«Âé®üçÚŸ±²Ìñ¿øÞ°¯õÁæ­ûÊîâïÃÕôûçµé÷°ÆêüªŽåŸúô«áÄô');
*/
...
/*insert into testdata_varchar (c1,c2,c3)  values('æ¥æ¬èª',' ','/?µ?ö??f?ÝøÀÚ?t?ª®?Î???Ë???ðnø§?íèÏ??Õ"?Ë?»?âõ??');
...
insert into testdata_text (c1,c2,c3)  values('default character','rglmjrqpasdilemrccs','ENCEN');
/*insert into testdata_text (c2,c3,c4)  values('"Double Quotes"','eexnwbmvvwuepqedqtspayhxqqmqkjsnsxpwmrpsjmyvwizkzdpjkxzmybjkotgpqbzrgzjkvqcanspbch','qkjsnsxpwmrpsjmyvwizkzdpjkxzmybjkotgp');
insert into testdata_text (c1,c2,c3)  values('qkjsnsxpwmrpsjmyvwizkzdpjkxzmybjkotgp',' ','qkjsnsxpwmrpsjmyvwizkzdpjkxzmybjkotgp');

insert into testdata_text (c1,c2,c3)  values('Male / Female','user''s log','qkjsnsxpwmrpsjmyvwizkzdpjkxzmybjkotgp');
...
insert into testdata_text (c1,c2,c3)  values('æ¥æ¬èª',' ','/?µ?ö??f?ÝøÀÚ?t?ª®?Î???Ë???ðnø§?íèÏ??Õ"?Ë?»?âõ??');
...
/*insert into testdata_timestampwithtimezone(c2,c3) values('4713-01-08 04:05:06 BC -8:00','299442	-01-08 04:05:06 AD -8:00');
...
/*insert into testdata_timestampwithouttimezone(c2,c3) values('4713-01-08 04:05:06 BC','299442-01-08 04:05:06 AD');
